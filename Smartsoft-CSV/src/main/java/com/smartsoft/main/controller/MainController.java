...
public class MainController {
    ...
    public String last(Model model) {
        ...
        model.addAttribute("records", usersForms.stream().map(uf -> new String[]{uf.ssoId(), uf.formIdsToString()}).toArray());
        return "main";
    }
    ...
    public String unfinished(Model model) {
        ...
        model.addAttribute("records", dbService.unfinishedForms().stream().map(uf -> new String[]{uf.ssoid(), uf.formid(), uf.subtype()}).toArray());
        return "main";
    }
